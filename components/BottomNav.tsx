...
import { LayoutDashboard, ArrowLeftRight, Target, TrendingUp, Lightbulb } from 'lucide-react';
...
const tabs = [
  ...
  { href: '/projections', icon: TrendingUp, label: 'Proyecciones' },
  { href: '/investments', icon: Lightbulb, label: 'Inversiones' },
];
